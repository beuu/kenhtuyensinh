    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <form class="form-horizontal" style="width:100%" role="form" method="POST"
                action="{{ route('commentedit',$data->id) }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-9">
                        <div
                            class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-12 control-label">Tên học sinh</label>
                        ...
                        <div
                            ...
                            <div class="col-md-12">
                                <input id="body" type="text" class="form-control" name="body"
                                    value="{{ $data->body }}" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ route('comment.index') }}">
                                    Hủy
                                </a>
                            </div>
                        </div>
