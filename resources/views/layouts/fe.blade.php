        ...
        <div class="container" style="padding:0px">
            <div class="row align-items-center justify-content-between">
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li id="menu-item-39079" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-39079"><a href="https://kenhtuyensinh24h.vn/"><i class="fa fa-home" aria-hidden="true"></i></a></li>
